...
SvgField.prototype.createLines = function createLines()
{
	...
	//<path d="M 215,286.875 A 91.5,91.5 0 0,1 215,433.125 z
	// Penalty area arc circle (left)
	/*
	tag = document.createElementNS( svgNS , 'path' ) ;
	tag.setAttribute( 'd' ,
		'M ' + ( - this.params.length / 2 + this.params.penaltyDistance ) + ' 0 ' +
		'A ' + this.params.penaltyDistance + ' ' + this.params.penaltyDistance + ' 0 0 215 433.125 z' 
	) ;
	svg.appendChild( tag ) ;
	*/
	...
	// Goal area (left)
	tag = document.createElementNS( svgNS , 'line' ) ;
	tag.setAttribute( 'x1' , - this.params.length / 2 + this.params.goalAreaLength ) ;
	tag.setAttribute( 'x2' , - this.params.length / 2 + this.params.goalAreaLength ) ;
	tag.setAttribute( 'y1' , - this.params.goalAreaWidth / 2 ) ;
	tag.setAttribute( 'y2' , this.params.goalAreaWidth / 2 ) ;
	svg.appendChild( tag ) ;
	
	tag = document.createElementNS( svgNS , 'line' ) ;
	tag.setAttribute( 'x1' , - this.params.length / 2 ) ;
	tag.setAttribute( 'x2' , - this.params.length / 2 + this.params.goalAreaLength + this.lineWidth / 2 ) ;
	tag.setAttribute( 'y1' , - this.params.goalAreaWidth / 2 ) ;
	tag.setAttribute( 'y2' , - this.params.goalAreaWidth / 2 ) ;
	svg.appendChild( tag ) ;
	...
	// Penalty area (left)
	tag = document.createElementNS( svgNS , 'line' ) ;
	tag.setAttribute( 'x1' , - this.params.length / 2 + this.params.penaltyAreaLength ) ;
	tag.setAttribute( 'x2' , - this.params.length / 2 + this.params.penaltyAreaLength ) ;
	tag.setAttribute( 'y1' , - this.params.penaltyAreaWidth / 2 ) ;
	tag.setAttribute( 'y2' , this.params.penaltyAreaWidth / 2 ) ;
	svg.appendChild( tag ) ;
	
	tag = document.createElementNS( svgNS , 'line' ) ;
	tag.setAttribute( 'x1' , - this.params.length / 2 ) ;
	tag.setAttribute( 'x2' , - this.params.length / 2 + this.params.penaltyAreaLength + this.lineWidth / 2 ) ;
	tag.setAttribute( 'y1' , - this.params.penaltyAreaWidth / 2 ) ;
	tag.setAttribute( 'y2' , - this.params.penaltyAreaWidth / 2 ) ;
	svg.appendChild( tag ) ;
