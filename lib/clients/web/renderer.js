...
renderer.prototype.draw = function() {
	...
	var ball = {
		x: state.ball.x + this.fieldWidth / 2 ,
		y: state.ball.y + this.fieldHeight / 2 ,
		z: state.ball.z
	} ;
	...
	var camera = {} ;
	camera.x = Math.min( ball.x - this.clientWidth / 2 , this.fieldWidth - this.clientWidth ) ;
	camera.y = Math.min( ball.y - this.clientHeight / 2 , this.fieldHeight - this.clientHeight ) ;
