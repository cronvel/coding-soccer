...
UI.create = function( options ) {
	...
	var defaultOptions = {
		...
		UIFrameRate: 1000 / 30 // UI frameRate
	} ;
	...
	var self = Object.create( UI.prototype , {
		...
		UIFrameRate: { value: options.UIFrameRate } ,
...
UI.prototype.replayUpdate = function() {
...
UI.prototype.addFrame = function( data ) {
...
UI.prototype.goto = function( position ) {
	this.playPosition = position ;
} ;



UI.prototype.cameraUpdate = function( ball ) {
...
UI.prototype.draw = function() {
	...
	if ( lastFrame < this.UIFrameRate ) {
		setTimeout( this.draw.bind( this ) , this.UIFrameRate - lastFrame ) ;
		return ;
	}
	else {
		var skipped = ( Math.round( lastFrame / this.UIFrameRate ) - 1 ) || 0 ;
